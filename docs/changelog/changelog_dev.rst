...
.. changelog::
    ...
    .. change::
        ...
        5. When SimulationOutputReport or ReportSimulationOutput is both missing in data_point_out.json (perhaps due to failure),
           add a key of {"ReportSimulationOutput": {"applicable": False}}. Previously, it would add
           {"SimulationOutputReport": {"applicable": False}}. SimulationOutputReport is outdated.
